...
<H4>The objective of this project is to do a comparative study to detect and classify music files automatically based on 
...
using various machine learning classification algorithms to classify music files based on its genre.</H4>

<H4>As per the accuracy results, we find that XGBooster has the highest accuracy of 90%, and then Random 
...
library we find the best similar matches to the given input audio.</H4>
